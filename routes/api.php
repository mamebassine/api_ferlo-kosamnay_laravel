...
Route::apiResource('categories', CategorieController::class)->middleware('jwt.auth'); // Protéger si nécessaire

// Routes pour les produits
Route::apiResource('produits', ProduitController::class)->middleware('jwt.auth'); // Protéger si nécessaire

// Routes pour les commandes
Route::apiResource('commandes', CommandeController::class)->middleware('jwt.auth'); // Protéger si nécessaire
